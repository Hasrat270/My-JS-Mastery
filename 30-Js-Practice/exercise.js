...
//  DONE  - The first button removes the third paragraph (i.e. the <p> prior to it)
//  DONE  - The second button changes the background color of the first paragraph to blue
